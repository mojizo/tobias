...
Future<Map> signFreePayment({String signParams = '', String urlScheme = ''}) async {
  return await _channel.invokeMethod("signFreePayment", {"sign_params": signParams, "url_scheme": urlScheme});
}
